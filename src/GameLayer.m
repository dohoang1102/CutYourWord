...
- (id) init{
	...
	if((self=[super init])) {
        ...
        //self.curves = [self.util generateRandomCurves:DEFAULT_WORDS];
        ...
        //self.labelBackground = [CCSprite spriteWithFile:@"labelBackground.png"];
        //[self.labelBackground setPosition:ccp(160,25)];
        //[self addChild:self.labelBackground z:1];
        //height 960x640 width
        ...
        //self.labelBackground2 = [CCSprite spriteWithFile:@"labelBackground.png"];
        //[self.labelBackground2 setPosition:ccp(160,400)];
        //[self addChild:self.labelBackground2 z:1];
        ...
        self.scoreValue = 0;
                      //labelWithString:@"0" fontName:@"Arial" fontSize:24];
        ...
        if([letObj isKindOfClass:[LetterObject class]])
        {
            if ([letObj containsTouchLocation:touch])
            {
                ...
                if(![self.currentWord containsObject:letObj])
                {
                    ...
                    //[[SimpleAudioEngine sharedEngine] playEffect:@"Plopp!.mp3"];
                    //pitch =
                    ...
                    //NSLog(@"current word count = %d",[self.currentWord count]);
                }
            }
